...
export default function RequestQuoteForm() {
    ...
    return (
      <div className="relative min-h-screen flex items-center justify-center mt-[64px]">
        ...
        <motion.div
          ...
          className="relative z-20 bg-white/95 backdrop-blur-md shadow-2xl rounded-2xl p-10 max-w-lg text-center"
        >
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
  ...
  // ---------- Main Form ----------
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-start mt-[64px]">
      <NeuralNetworkBackground />
      <div className="relative z-20 w-full max-w-3xl px-6 py-16 font-orbitron bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl">
        ...
        <div className="relative min-h-[200px]">
          <AnimatePresence mode="wait">
            ...
            {step === 1 && (
              ...
              >
                <p className="text-lg text-gray-700">
                  Hi there! What’s your <strong className="text-cyan-500">full name</strong>?
                </p>
                <input
                  type="text"
                  name="name"
            ...
            {step === 2 && (
              ...
              >
                <p className="text-lg text-gray-700">
                  Great! What’s the best <strong className="text-purple-500">email</strong> to reach you?
                </p>
                <input
                  type="email"
                  name="email"
          ...
          {step < steps ? (
            ...
            <button
              ...
              className={`px-8 py-3 text-white font-semibold rounded-lg shadow-lg hover:scale-105 transition-transform ${
                submitting ? "bg-gray-400 cursor-not-allowed" : "bg-gradient-to-r from-green-400 to-blue-500"
              }`}
            >
